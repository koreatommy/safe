...
import { YangjuRiskReportList } from "./YangjuRiskReportList";
import { YANGJU_RISK_REPORTS } from "./yangju-risk-reports";

export const metadata: Metadata = {
  title: "양주시 신종유사놀이시설 위험성 평가 보고서",
  description:
    "양주시 신종·유사 어린이놀이시설 대상 위험성 평가 결과를 시설별로 확인할 수 있습니다.",
};

export default function YangjuRiskReportsPage() {
  return (
    <div className="gimpo-risk-reports relative min-h-screen bg-[#f7f8fa]">
      ...
      <main className="relative mx-auto w-full max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
        <Link
          className="mb-6 inline-flex items-center gap-1.5 text-sm font-medium text-[#3772b8] transition hover:text-[#1a2744]"
          href="/report/yangju"
        >
