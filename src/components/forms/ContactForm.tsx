  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        let errorMessage = '문의사항 저장 중 오류가 발생했습니다. 다시 시도해주세요.';
    ...
    setTimeout(() => {
      ...
      setErrors({ submit: '문의사항 저장 중 오류가 발생했습니다. 다시 시도해주세요.' });
      setIsSubmitting(false);
    }
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        >
          ...
          문의사항 <span className="text-[#00ff88]">*</span>
        </label>
        <textarea
          id="inquiry"
          name="inquiry"
          ...
          onChange={handleChange}
          rows={6}
          className="w-full px-4 py-3 rounded-xl glass-panel border border-white/10 text-white placeholder-white/40 focus:outline-none focus:border-[#00ff88] transition-all resize-none"
            ...
            >
              <div className="glass-panel p-4 md:p-6 rounded-xl border border-white/10 max-h-[60vh] overflow-y-auto space-y-3">
                ...
                <p className="text-xs text-white/70 leading-relaxed mb-4">
                  「개인정보 보호법」에 따라 문의사항 접수 및 답변을 위한 최소한의 개인정보를 수집합니다.
                </p>
    ...
    <div className="space-y-2">
      ...
      >
        <ul className="space-y-1.5 text-xs text-white/70">
          <li className="flex gap-2"><span className="text-[#00ff88]">•</span> 문의사항 접수 및 본인 확인</li>
          <li className="flex gap-2"><span className="text-[#00ff88]">•</span> 문의사항 답변 및 안내</li>
          <li className="flex gap-2"><span className="text-[#00ff88]">•</span> 서비스 개선 및 품질 향상</li>
        </ul>
      </AccordionSection>
        ...
        <div className="space-y-3">
          <div className="p-2.5 rounded-lg bg-[#00ff88]/5 border border-[#00ff88]/20">
            ...
            <div className="flex flex-wrap gap-1.5 text-xs text-white/80">
              ...
              <span className="px-2 py-1 rounded bg-white/5">문의사항</span>
            </div>
          </div>
        </div>
      </AccordionSection>
      ...
      >
        <ul className="space-y-1.5 text-xs text-white/70">
          <li className="flex gap-2">
            ...
            <span>문의사항 답변 완료 후 <span className="text-[#00ff88] font-semibold">3년간 보관</span> 후 즉시 파기</span>
          </li>
      ...
      >
        <ul className="space-y-1.5 text-xs text-white/70">
          ...
          <li className="flex gap-2">
            ...
            <span>다만, <span className="text-amber-300 font-semibold">필수항목에 대한 동의가 없을 경우</span> 문의사항 접수 및 답변이 제한될 수 있습니다.</span>
          </li>
        </ul>
      </AccordionSection>
    </div>
