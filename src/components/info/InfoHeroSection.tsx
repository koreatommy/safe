        ...
        >
          <GlassPanel className="p-8 md:p-12 border-[#1e3a5f]/30">
            <div className="space-y-6">
              <p className="text-neon-green text-sm md:text-base font-medium tracking-wide">
                양주시 어린이놀이시설 안전관리
              </p>
              <h1 className="text-white font-medium leading-tight text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
                양주시 어린이놀이시설
                <br />
                <span className="text-neon-green">안전관리자 교육</span>
              </h1>
              ...
              <p className="text-white/70 text-sm md:text-base leading-relaxed border-l-2 border-[#00ff88]/50 pl-4">
          ...
          <div className="flex flex-wrap gap-2 md:gap-3 justify-center md:justify-start">
            {HERO_BADGES.map((badge) => (
              <span
                key={badge}
                className="px-3 py-1.5 rounded-full text-xs md:text-sm font-medium bg-[#1e3a5f]/60 text-white border border-[#00ff88]/40"
              >
                {badge}
              </span>
            ))}
